# Oven dataset (2900 images in YOLO format

# Body

Electric Oven Dataset (2900 images, YOLO format， clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort
